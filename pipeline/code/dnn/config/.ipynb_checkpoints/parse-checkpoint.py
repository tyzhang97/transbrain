...
def parse_arguments():
    ...
    parser.add_argument('-br','--use_bestrank',type=bool,default=True,help='Select model by performance of cross-species rank.')
    parser.add_argument('-bv','--use_bestvalid',type=bool,default=False,help='Select model by performance of validation.')
    
    # cross species path
    parser.add_argument('-g_path','--gene_path',type=str,default=None,help='.csv path to common gene list file. Columns: | genes |')
    parser.add_argument('-d_path','--data_path',type=list, default=None,help='[.h5ad training dataset path]. Required fields:|X (expression matrix), obs (brain_region: {region id}_{sample id}_{cell id}), var (gene)|')
    parser.add_argument('-s_path','--save_path',type=str,default=None,help='Output path for model.')
    parser.add_argument('-m_trans_path','--mouse_trans_path',type=str,default=None,help='.h5ad path of mouse transform. Required fields:|X (expression matrix), obs (brain_region), var (gene)|')
    parser.add_argument('-h_trans_path','--human_trans_path',type=str,default=None,help='.h5ad path of human transform. Required fields:|X (expression matrix), obs (brain_region), var (gene)|')

    # independent test path
    parser.add_argument('-id_path','--independent_data_path',type=list,default=None,help='[.h5ad independent training dataset path]. Required fields:|X (expression matrix), obs (brain_region: {region id}_{sample id}_{cell id}), var (gene)|')
    parser.add_argument('-is_path','--independent_s_path',type=str,default=None,help='Output path for independent results.')
    parser.add_argument('-itest_path','--independent_test_path',type=str,default=None,help='.h5ad independent testing dataset path. Required fields:|X (expression matrix), obs (brain_region: {region id}_{sample id}_{cell id}), var (gene)|')
