...
class TestTransBrain(unittest.TestCase):
    ...
    def test_human_phenotype_extraction(self):
        ...
        check_data = np.load(base_dir.joinpath('tests/human_phenptype_extracted.npy'))
        human_atlas = tb.atlas.fetch_human_atlas(atlas_type='bn',region_type='cortex')
        result = tb.base.get_region_phenotypes(path, atlas_dict = human_atlas)
    ...
    def test_mouse_phenotype_extraction(self):
        ...
        check_data = np.load(base_dir.joinpath('tests/mouse_phenptype_extracted.npy'))
        mouse_atlas = tb.atlas.fetch_mouse_atlas(region_type='all')
        result = tb.base.get_region_phenotypes(path, atlas_dict = mouse_atlas)
